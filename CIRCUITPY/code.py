...
def power(sound, duration, reverse):
    ...
    Animate NeoPixels with accomp
            ...
            character = 3anying sound effect for power on / off.
...
def setColors(color):
    """
    Recieves base color and sets global values for other COLOR variables
    @param color: base color to be used
    @return: nothing
    """
    COLOR = color              # set it to dark and re-light
    # "Idle" color is 1/4 brightness, "swinging" color is full brightness...
    COLOR_IDLE = (int(COLOR[0] / 1), int(COLOR[1] / 1), int(COLOR[2] / 1))
    COLOR_SWING = COLOR
    COLOR_HIT = (255, 255, 255)  # "hit" color is white"""LASER SWORD (pew pew) example for Adafruit Hallowing & NeoPixel strip"""
# pylint: disable=bare-except
...
GREEN_COLOR = (47,249,36)
GREEN_NAME = "LUKE.wav"
GREEN_TIME = 15

YELLOW_COLOR = (255, 243, 62)
YELLOW_NAME = "REY.wav"
YELLOW_TIME = 12
...
change.direction = Direction.INPUT
change.pull = Pull.UP
character = 0                                # Initial mode = LIGHT
...
while True:
    ...
    if not change.value:                            # button pressed?
        ...
        # elif character == 4:
        #     COLOR = WHITE_COLOR                     # set it to new color and re-light
        #     # "Idle" color is 1/4 brightness, "swinging" color is full brightness...
        #     COLOR_IDLE = (int(COLOR[0] / 1), int(COLOR[1] / 1), int(COLOR[2] / 1))
        #     COLOR_SWING = COLOR
        #     COLOR_HIT = (255, 255, 255)             # "hit" color is white
